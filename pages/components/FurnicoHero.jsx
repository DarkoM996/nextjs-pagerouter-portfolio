  ...
  return (
    ...
    <div className="max-w-screen-xl mx-auto w-full h-full relative px-6 py-4">
      ...
      <h3 className="text-2xl md:text-3xl font-medium text-primary_backgroundDarkerColor-600">
        Days is a beautiful countdown app to all the events that matter to you.
        Events are important, they're the small things in life that matter the
        most. Whether it's a wedding, a holiday or just a night out with your
        friends.
      </h3>
    </div>
  );
