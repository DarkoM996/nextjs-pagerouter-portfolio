...
const ProjectSection = () => {
  return (
    <div className=" max-w-screen-2xl mx-auto min-h-screen relative px-6 py-4 bg-primary_backgroundLighterColor-400">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-24 lg:px-32">
        {/* Project #1 */}
